 ...
 */
?>
<div class="outer-wrapper" xmlns="http://www.w3.org/1999/html">
    ...
    <div id="main" class="clearfix">
      ...
      <div id="content" class="column">
        <div class="section">
          ...
          <section
            class="section section-media<?php empty($top_image) ? print (" no-image") : '' ?>">
            ...
            <div class="valign">
              <div class=" container">
                ...
                <?php if (!empty($multiline_title)): ?>
                  <?php print render($title_prefix); ?>
                  <h1>  <?php print render($multiline_title); ?></h1>
                  <?php print render($title_suffix); ?>
                <?php endif; ?>
